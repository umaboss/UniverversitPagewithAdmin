...
import { useJobs } from "@/pages/JobPosts/JobContext";
            ...
            <tbody className="divide-y divide-gray-200">
              {jobs.map((job) => (
                <tr key={job.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-600">{job.siteType}</td>
      ...
      {selectedJob && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white max-w-xl w-full rounded-xl shadow-xl p-6">
            ...
            <p><strong>Location:</strong> {selectedJob.location}, {selectedJob.province}, {selectedJob.country}</p>
            <p><strong>Job Type:</strong> {selectedJob.jobType} ({selectedJob.siteType})</p>
            ...
            <p className="mt-2"><strong>Responsibilities:</strong> {selectedJob.responsibilities}</p>
            {selectedJob.details && (
              <p className="mt-2"><strong>Details:</strong> {selectedJob.details}</p>
            )}
