...
const complaints = [
  { id: 1, name: "Usman Tariq", email: "usman@email.com", complaint: "Delay in response.", date: "2024-06-03" },
  { id: 2, name: "Maria Iqbal", email: "maria@email.com", complaint: "Incorrect information provided.", date: "2024-06-04" },
];
            ...
            <tbody className="divide-y divide-gray-200">
              {complaints.map((msg) => (
                <tr key={msg.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-3 px-4 text-gray-600">{msg.complaint}</td>
